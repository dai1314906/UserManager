...
public class UserDaoImpl implements UserDao {
    ...
    public void add(User user) {
        ...
        template.update(sql,user.getName(),user.getGender(),user.getAge(),user.getAddress(),user.getScore(),user.getEmail());
    }
    ...
    public void update(User user) {
        String sql = "update tb_user set name = ?,gender = ?,age = ?,address = ?,score = ?,email = ? where id = ?";
        template.update(sql,user.getName(),user.getGender(),user.getAge(),user.getAddress(),user.getScore(),user.getEmail(),user.getId());
    }
